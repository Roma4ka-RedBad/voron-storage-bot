...
class Archive:
    def __init__(self, file_name: str, user_message_id: int, chat_id: int, platform_name: str, object_id: int = None):
        self.user_message_id = user_message_id
        self.bot_message_ids = []
        self.chat_id = chat_id
        self.platform_name = platform_name

        self.object_id = object_id or random.randint(0, 10000000)
    ...
    def __repr__(self):
        return f"<Archive id={self.object_id} path={self.file_path.resolve()}>"
